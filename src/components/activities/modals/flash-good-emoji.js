...
const yes_emoji = [EM7, EM25, EM20, EM8, EM35, EM33, EM15]
const userDetails = JSON.parse(localStorage.getItem("user"))
var image

const FlashGoodEmojiModal = ({
    pref,
    ...
    const handleYes = () => {
        ...
        audio.play()
        setIsFlashEmojiModalOpen(false)
    }
    ...
    return (
        <div className="activity-progress-container-status">
            ...
            <div>
                ...
                <span className="btn-flash-img">
                    <img src={yes_emoji[ind_emoji]} style={{ width: "5rem" }} />
                </span>
            </div>
        </div>
    )
...
export default FlashGoodEmojiModal
