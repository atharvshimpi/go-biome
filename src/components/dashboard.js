        ...
        <div className="dashboard-container">
            ...
            <div className="bottom-view">
                ...
                <div className="activity-cards">
                    <div style={{ backgroundColor: "green" }} className="cards"></div>
                    <div style={{ backgroundColor: "yellow" }} className="cards"></div>
                    <div style={{ backgroundColor: "violet" }} className="cards"></div>
                    <div style={{ backgroundColor: "pink" }} className="cards"></div>
                </div>
                <div className="icon-container">
