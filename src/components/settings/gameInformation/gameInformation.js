    ...
    return (
        <div className="gameInformation-container">
            ...
            <div className="gameInformation-section-row">
                ...
                <div
                    className="gameInformation-section-col"
                    style={{ width: "80%" }}
                >
                    <p>
                    ...
                    <p>
                        Appears when the biome needs attention. Engage in an
                        activity to increase biome energy level
                    </p>
                </div>
            </div>
            <div className="gameInformation-section-row">
            ...
            <div className="gameInformation-section-row">
                ...
                >
                    ...
                    <p>
                        Appears when an activity is in progress to indicate that
                        the biome energy is getting charged
                    </p>
                </div>
            </div>
            <div className="gameInformation-section-row">
                ...
                >
                    <p>
                        <strong>Partial Strength</strong>
                    </p>
            ...
            <div className="gameInformation-section-row">
                ...
                >
                    <p>
                        <strong>Biome Diversity</strong>
                    </p>
                    <p>
                        Indicates full energy and diversity in the friendly
                        biome population
                    </p>
                </div>
            </div>
            <div className="gameInformation-section-row">
                ...
                >
                    <p>
                        <strong>Super Diversity</strong>
                    </p>
                    <p>
                        Indicates full energy and greater diversity in the
                        friendly biome population
                    </p>
                </div>
            </div>
            <div className="gameInformation-section-header">
            ...
            <div className="gameInformation-section-row row-center">
                ...
                >
                    Engage in an activity of your choice. Try to engage in
                    activities from two or more decks each day to help Bugsy
                    gain more friends to protect the trail.
                </p>
            </div>
            <div className="gameInformation-section-header">
            ...
            <div
                className="gameInformation-section-row row-baseline"
                style={{
                    flexWrap: "wrap",
                    marginTop: "20px",
                    marginBottom: "50px",
            ...
            >
                ...
                >
                    ...
                    >
                        Generates a random activity card for you
                    </p>
                </div>
                <div
                    className="gameInformation-section-col col-center"
                ...
                >
                    ...
                    >
                        Watch your friendly biome as it moves ahead on the
                        trail.
                    </p>
                </div>
                <div
